#!/usr/bin/env python3
"""
Pi05 JAX 推理服务（平移自 star1_vla_inference）。
...
logger = logging.getLogger("pi05_jax")
...
# =============================================================================
# 模型加载（平移自 star1_vla_inference/inference.py）
# =============================================================================
...
def load_model():
    ...
    _policy = _policy_config_module.create_trained_policy(train_config, checkpoint_dir)
...
# =============================================================================
# ZMQ 服务（平移自 star1_vla_inference/server.py）
# =============================================================================

def parse_args():
    p = argparse.ArgumentParser(description="Pi05 JAX Inference Server")
...
def main():
    ...
    logger.info("=" * 60)
    logger.info(f"Pi05 JAX Inference Server")
