...
import training.models.gemma
import training.models.model
import training.models.pi0_config
import training.models_pytorch.pi0_pytorch
...
def slice_initial_orbax_checkpoint(checkpoint_dir: str, restore_precision: str | None = None):
    ...
    params = training.models.model.restore_params(
...
def convert_pi0_checkpoint(
    checkpoint_dir: str, precision: str, output_path: str, model_config: training.models.pi0_config.Pi0Config
):
    """
    ...
    action_expert_config = training.models.gemma.get_config("gemma_300m")
    ...
    # Instantiate model
    pi0_model = training.models_pytorch.pi0_pytorch.PI0Pytorch(model_config)
...
def main(
    ...
    *,
    ...
    if not isinstance(model_config, training.models.pi0_config.Pi0Config):
