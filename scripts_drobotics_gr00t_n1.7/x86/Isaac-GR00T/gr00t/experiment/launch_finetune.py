...
if __name__ == "__main__":
    ...
    config.model.use_albumentations_transforms = (
        os.environ.get("GR00T_USE_ALBUMENTATIONS", "1") == "1"
    )
    ...
    config.model.model_name = os.environ.get("GR00T_COSMOS_PATH", "nvidia/Cosmos-Reason2-2B")
    ...
    # GR00T_USE_DDP=1 -> plain DDP (optimizer states replicated, more VRAM, same math) instead of ZeRO-2
    config.training.use_ddp = os.environ.get("GR00T_USE_DDP", "0") == "1"
