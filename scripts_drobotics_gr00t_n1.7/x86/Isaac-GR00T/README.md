...
- 源仓库: https://github.com/NVIDIA/Isaac-GR00T
- git commit: `b9955401d50c92a29258732e3ad6ccd579f1bdc0` (2026-07-31, "Add: support for the real reBot arm B601 robotic arm (#709)")
- 在该 commit 之上含 M7 双臂人形适配的未提交修改: 相机系 delta 表示(camera_frame)、M7 modality 配置(examples/M7/m7_config.py)、三相机异分辨率 center-crop 适配、qwen3 backbone 与数据管线的修改,以及 train_m7_cam_20m.sh(训练入口)和 serve_m7_eval.py(推理入口)
- .git 目录已从本快照移除,上述未提交修改无法用 git 追溯,快照内容即最终内容
